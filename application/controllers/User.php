...
class User extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['link'] = $this->link;
        $data['data'] = $this->model->select('tb_user.*, nama_role, nama_bimbel, cabang')->join('tb_role', 'tb_role.id = tb_user.id_role')->join('tb_bimbel', 'tb_bimbel.id_bimbel = tb_user.id_bimbel')->where('id_role', 2)->findAll();
